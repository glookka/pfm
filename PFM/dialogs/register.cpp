...
#define RUREG_HEADER1 L"Регистрация"
#define RUREG_HEADER2 L"Русскоязычная регистрация."
#define RUREG_TEXT L"Вы можете поддержать развитие проекта, перечислив любую сумму на кошельки:\n\n WebMoney: R143261032891 Z435769869984\n Яндекс.Деньги: 41001137416812"
